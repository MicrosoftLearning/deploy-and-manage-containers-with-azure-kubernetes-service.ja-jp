...
1. **[Kubernetes クラスターの作成]** ページの **[ネットワーク]** タブで、**[Azure CNI]** オプションを選択し、**[仮想ネットワーク]** ドロップダウン リストで** [独自の仮想ネットワークを提供する] **チェックボックスをオンにします。また、**[vnet-01]** を選択し、**[クラスター サブネット]** テキストボックスの下にある **[マネージド サブネットを構成]** を選択します。
